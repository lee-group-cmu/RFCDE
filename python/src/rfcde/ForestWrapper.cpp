...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initForestWrapper(void); /*proto*/
PyMODINIT_FUNC initForestWrapper(void)
#else
PyMODINIT_FUNC PyInit_ForestWrapper(void); /*proto*/
PyMODINIT_FUNC PyInit_ForestWrapper(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_ForestWrapper(void)", 0);
